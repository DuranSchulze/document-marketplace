...
import { n as require_src$2, t as require_src$3 } from "./gcp-metadata+[...].mjs";
...
var require_getCredentials = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var readFile = fs$4.readFile ? (0, util_1$1.promisify)(fs$4.readFile) : async () => {
...
var require_filesubjecttokensupplier = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var readFile = (0, util_1.promisify)(fs$3.readFile ?? (() => {}));
	var realpath = (0, util_1.promisify)(fs$3.realpath ?? (() => {}));
	var lstat = (0, util_1.promisify)(fs$3.lstat ?? (() => {}));
	/**
...
//#endregion
export { require_jws as n, require_src as t };
