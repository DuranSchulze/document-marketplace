	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./_10.mjs");
...
//#endregion
export { AbortError as a, isRedirect as c, init_src as i, Headers as l, toFormData as n, Request as o, fetch as r, Response as s, init_multipart_parser as t, FetchError as u };
