import { $t as logger, Bt as initGetModelName, D as any, Et as encode, F as object, Ft as ATTR_CONTEXT, Ht as generateId, I as optional, It as ATTR_HOOK_TYPE, Jt as BetterAuthError, K as decodeProtectedHeader, L as record, Lt as ATTR_OPERATION_ID, N as looseObject, Nt as safeJSONParse, O as array, P as number, Pt as withSpan, Qt as createLogger, R as string, Rt as import_src, S as filterOutputFields, Ut as createRandomStringGenerator, Vt as initGetFieldName, W as base64Url, Xt as kAPIErrorHeaderSymbol, Yt as APIError$1, Zt as BASE_ERROR_CODES, _ as hasRequestState, a as normalizeIP, an as isDevelopment, b as runWithEndpointContext, c as createAuthEndpoint, d as toResponse, en as shouldPublishLog, f as getCurrentAdapter, g as defineRequestState, h as runWithTransaction, i as isValidIP, j as email, k as boolean, l as createAuthMiddleware, m as runWithAdapter, n as socialProviders, nn as env, o as deprecate, on as isProduction, p as queueAfterTransactionHook, q as jwtVerify, qt as APIError, r as createRateLimitKey, s as normalizePathname, sn as isTest, t as SocialProviderListEnum, u as createRouter$1, v as runWithRequestState, x as getBetterAuthVersion, xt as JWTExpired, y as getCurrentAuthContext, zt as getAuthTables } from "../_libs/@better-auth/core+[...].mjs";
import { a as isDynamicBaseURLConfig, c as wildcardMatch, i as getProtocol, n as getHost, o as isRequestLike, r as getOrigin, s as resolveBaseURL, t as getBaseURL } from "./url-je-Xz54-.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-Dz_UM7w5.js
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import("../_libs/_7.mjs");
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("../_libs/_2.mjs").then((n) => n.t);
...
var auth_exports = /* @__PURE__ */ __exportAll({ auth: () => auth });
var isProd = true;
var auth = betterAuth({
...
//#endregion
export { auth as n, auth_exports as r, __exportAll as t };
