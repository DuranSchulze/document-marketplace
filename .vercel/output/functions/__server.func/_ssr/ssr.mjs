...
import { C as rootRouteId, D as invariant, _ as resolveManifestAssetLink, a as RouterProvider, b as isResolvedRedirect, t as renderRouterToStream, v as executeRewriteInput, w as isNotFound, x as parseRedirect, y as isRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { n as getResponse, r as requestHandler } from "./server-BGpc65_n.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CEUDzMIb.mjs");
...
var manifest = {
	"b449ba72fa033df9f2e5736c157390be7efca428e78bb8808fb1d92c1cc60757": {
		functionName: "getDocument_createServerFn_handler",
		importer: () => import("./edit-CEJVMSjH.mjs")
	},
	"89b109b4ae092eb49120e7c38025039f043a02462b83affd9d685c2cfda46dd2": {
		functionName: "getDocuments_createServerFn_handler",
		importer: () => import("./routes-PV7ij2kZ.mjs")
	},
	"01f7ef4449bd28eba5d521339302f1ce76f109e3d13d8360c8495215ee1d5ef2": {
		functionName: "getDocument_createServerFn_handler",
		importer: () => import("../_id-lRwZUzy22.mjs")
	},
	"e6964737eacbc878ab2053145f2cbe547d409e9c801a5722516496e9faaef8aa": {
		functionName: "getDocument_createServerFn_handler",
		importer: () => import("../_id-BexxSlMO.mjs")
	},
	"0a0f3826c77bea78fac5482c4ce30daa518af8025800efa6c731568c9817f261": {
		functionName: "checkAdminSession_createServerFn_handler",
		importer: () => import("../_admin-DpDkN9IH.mjs")
	},
	"756068f5114885a050c115559736aef13007c91cab6a583c7f7476592d5e770b": {
		functionName: "redirectIfAuthenticated_createServerFn_handler",
		importer: () => import("./login-DMNlL4Qg.mjs")
	},
	"912a64cbbffc2a4d2eb38da171f95874f393acb6c95525913e5405925b7a2564": {
		functionName: "getAdminDocuments_createServerFn_handler",
		importer: () => import("./dashboard-D1_71vh2.mjs")
	},
	"278a9dc39dddb9e463e5ccaa2f561f671d7ee7f2a27bb10c930fe86834fc958f": {
		functionName: "getAdminOrders_createServerFn_handler",
		importer: () => import("./orders-dhil-v6s.mjs")
	}
};
...
//#endregion
export { server_default as a, getServerFnById as i, createServerEntry as n, createServerFn as r, TSS_SERVER_FUNCTION as t };
